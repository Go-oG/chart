...
import 'package:e_chart/src/charts/calendar/view.dart';
...
class CalenderGeom extends Geom {
  late int year;
  late int month;
  late num shapeSize;
  CalendarShape? shape;
  ...
  CalenderGeom(List<RawData> dataSet, this.year, this.month, this.shapeSize,
      {this.shape,
  ...
  @override
  GeomType get geomType => GeomType.custom;
}
