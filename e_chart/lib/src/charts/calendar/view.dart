...
class CalendarView extends ChartView {
  late final CalenderGeom _props;
  ...
  CalendarView(super.context, CalenderGeom props) {
    _props = props;
    _mPaint = Paint();
  ...
  void _draw(Canvas2 canvas, num width, num height) {
  ...
  void _drawWeek(Canvas2 canvas, num w, num h) {
  ...
  // 绘制日期和分割线
  void _drawDate(Canvas2 canvas, num w) {
  ...
  /// @param chosen 表示是否选中
  void _drawNode(Canvas2 canvas, _DateNode node, _Position position, _NodeType type, bool chosen) {
  ...
  /// @param height 矩形高度
  /// @param radius 圆角半径
  void _drawRoundRect(Canvas2 cxt, num x, num y, num width, num height, num radius, Paint paint) {
    cxt.drawRRect(
