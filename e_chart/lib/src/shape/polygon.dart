...
///多边形(封闭的)
/// TODO 有问题
class Polygon extends CShape {
  static final Polygon zero = Polygon([]);
  late List<Offset> points;
  bool pathUseHull;

  Polygon(this.points, [this.pathUseHull = false]);

  Polygon.from(Iterable<Offset2> points, [this.pathUseHull = false]) {
