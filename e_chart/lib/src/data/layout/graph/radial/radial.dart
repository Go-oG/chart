...
class GRadialTransform extends GTransform {
  ...
  void transform(Context context, double width, double height, Graph? graph) {
    ...
    ///使用GridLayout预先布局一次
    var gridLayout = GGridTransform(childFun, preventOverlap: true, nodeSpaceFun: nodeSpaceFun);

    gridLayout.transform(context, width, height, graph);
    ...
    GMDSTransform mds = GMDSTransform(childFun, linkDistance: linkDistance);
