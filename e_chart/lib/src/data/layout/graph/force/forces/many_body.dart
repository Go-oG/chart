...
class ManyBodyForce extends GForce {
  LCG _random = DefaultLCG();
  GForceFun _strengthFun = (a, b, c, w, h) {
    return -30;
  };
  num _minDistance = 1;
  ...
  ManyBodyForce({GForceFun? strengthFun, num? minDistance, num? maxDistance, num? theta}) {
    if (strengthFun != null) {
  ...
  ManyBodyForce setStrength(GForceFun fun) {
    _strengthFun = fun;
    _initialize();
    return this;
  }
