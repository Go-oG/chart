...
///径向力
class RadialForce extends GForce {
  ///节点强度函数
  ...
  ///返回节点位于的圆圈半径大小
  ///相同的半径大小将处于同一个圆
  GForceFun _radiusLevelFun = (node, i, list, w, h) {
    return min(w, h) * 0.5;
  };
  ...
  RadialForce setStrength(GForceFun fun) {
    _strengthFun = fun;
    _initialize();
    return this;
  }

  RadialForce setRadius(GForceFun fun) {
    _radiusLevelFun = fun;
    _initialize();
    return this;
  }
