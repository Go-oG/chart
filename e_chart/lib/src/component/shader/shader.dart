...
abstract class CShader {
  ...
  CShader lerp(covariant CShader end, double t);
  ...
  static CShader? lerpShader(CShader? start, CShader? end, double t) {
  ...
  static CShader _lerpShader2(CShader shader, double t, bool from) {
