...
class RadialShader extends CShader {
  ...
  @override
  CShader lerp(covariant RadialShader end, double t) {
    List<Color> colorList = CShader.lerpColors(colors, end.colors, t);
    List<double>? stepList = CShader.lerpDoubles(colorStops, end.colorStops, t);
    return RadialShader(
      colorList,
      colorStops: stepList,
  ...
  @override
  CShader convert(Set<NodeState>? states) {
